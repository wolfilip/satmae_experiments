...
with open("/home/filip/resics-45-train-val/val-resisc-metadata.txt", "w") as metadata_file:
            ...
            for line in train_file:
                ...
                for dir_list_name in dir_list:
                    if dir_name == dir_list_name:
                        metadata_file.write(str(dir_list.index(dir_list_name)) + ',' + path_dataset + dir_name + '/' + file_name + '\n')
