...
BASE_DIR = Path(
    "/home/filip/satmae_experiments/outputs/images/geobench_crop_100pc_results"
)
...
html_parts = [
    "<html><head><meta charset='utf-8'><title>geobench_crop per-image IoU comparison</title>",
    f"<style>{css}</style>",
    "</head><body>",
]
html_parts.append(
    "<div class='header'><h1>geobench_crop Per-Image IoU Comparison (Sorted by Max Difference)</h1>"
)
