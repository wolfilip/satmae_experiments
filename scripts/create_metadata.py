...
df = pd.read_csv("/home/filip/resics-45/train-resisc-metadata.txt")
...
print(len(data_keys))
_, new_arr = train_test_split(data_keys, test_size=0.05)
print(len(new_arr))
...
df_new.to_csv("train_62classes_new_1pc.csv", index=False)
